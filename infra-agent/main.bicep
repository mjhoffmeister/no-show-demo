...
// ACR (only when enableHostedAgents is true)
output AZURE_AI_PROJECT_ACR_CONNECTION_NAME string = enableHostedAgents ? aiProject.outputs.dependentResources.registry.connectionName : ''
output AZURE_CONTAINER_REGISTRY_ENDPOINT string = enableHostedAgents ? aiProject.outputs.dependentResources.registry.loginServer : ''
