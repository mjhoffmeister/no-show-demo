...
workspace_name = "mlw-noshow-dev-ncus-001" # PLACEHOLDER
subscription_id = "c94297dc-12b3-40c7-a773-64846b40a34c" # PLACEHOLDER
resource_group = "rg-noshow-dev-ncus-001" # PLACEHOLDER
experiment_name = "noshow-prediction" # PLACEHOLDER
iteration = "18"  # PLACEHOLDER
run_id = "witty_lettuce_yl3kg689r9_18"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/noshow-prediction','subscription_id':'c94297dc-12b3-40c7-a773-64846b40a34c','resource_group':'rg-noshow-dev-ncus-001','workspace_name':'mlw-noshow-dev-ncus-001','compute_target':'cpu-cluster','iterations':20,'primary_metric':'AUC_weighted','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':5,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':2,'max_nodes':1,'iteration_timeout_minutes':20,'enforce_time_on_windows':False,'experiment_timeout_minutes':60,'exit_score':'NaN','experiment_exit_score':'NaN','auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_priority':'dedicated','label_column_name':'no_show','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2,'vm_type':'Standard_DS3_v2','process_count_per_instance':0,'gpu_memory_gb':0.0,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN']} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','verbosity':20,'ensemble_iterations':15,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'compute_target':'cpu-cluster','subscription_id':'c94297dc-12b3-40c7-a773-64846b40a34c','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"witty_lettuce_yl3kg689r9_18\",\"experiment_name\":\"noshow-prediction\",\"workspace_name\":\"mlw-noshow-dev-ncus-001\",\"subscription_id\":\"c94297dc-12b3-40c7-a773-64846b40a34c\",\"resource_group_name\":\"rg-noshow-dev-ncus-001\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"/subscriptions/c94297dc-12b3-40c7-a773-64846b40a34c/resourceGroups/rg-noshow-dev-ncus-001/providers/Microsoft.MachineLearningServices/workspaces/mlw-noshow-dev-ncus-001/data/noshow-training-data/versions/1\",\"ResolvedUri\":\"azureml://subscriptions/c94297dc-12b3-40c7-a773-64846b40a34c/resourcegroups/rg-noshow-dev-ncus-001/workspaces/mlw-noshow-dev-ncus-001/datastores/workspaceblobstore/paths/LocalUpload/2f77e45a9aefcfb266ecc80fd6dc0cb1f78effaeab7b2c7f91dceaf8f93622c1/ml_prepared/\",\"AssetId\":\"azureml://locations/northcentralus/workspaces/679fce19-0310-4984-9ffe-e6cf10835814/data/noshow-training-data/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
