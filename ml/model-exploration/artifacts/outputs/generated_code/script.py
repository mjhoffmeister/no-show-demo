...
automl_run_id = 'witty_lettuce_yl3kg689r9_18'
...
def generate_data_transformation_config():
    ...
    column_group_1 = ['new_patient_flag', 'webschedulableyn']
    
    column_group_0 = ['appointmenttypename', 'virtual_flag', 'appointmentduration']
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingClassifier(
        ...
        weights=[0.3333333333333333, 0.06666666666666667, 0.06666666666666667, 0.13333333333333333, 0.26666666666666666, 0.06666666666666667, 0.06666666666666667]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://subscriptions/c94297dc-12b3-40c7-a773-64846b40a34c/resourcegroups/rg-noshow-dev-ncus-001/workspaces/mlw-noshow-dev-ncus-001/datastores/workspaceblobstore/paths/LocalUpload/2f77e45a9aefcfb266ecc80fd6dc0cb1f78effaeab7b2c7f91dceaf8f93622c1/ml_prepared/',     help='Default training dataset uri is populated from the parent run')
