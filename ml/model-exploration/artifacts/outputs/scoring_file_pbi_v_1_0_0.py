...
data_sample = PandasParameterType(pd.DataFrame({"appointmenttypename": pd.Series(["example_value"], dtype="object"), "virtual_flag": pd.Series(["example_value"], dtype="object"), "new_patient_flag": pd.Series(["example_value"], dtype="object"), "appointmentduration": pd.Series([0], dtype="int64"), "webschedulableyn": pd.Series([0], dtype="int64")}))
